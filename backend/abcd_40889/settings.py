"""
Django settings for abcd_40889 project.
...
WSGI_APPLICATION = 'abcd_40889.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abcd_40889 API",
    "DESCRIPTION": "API documentation for abcd_40889 App",
    "VERSION": "v1",
}
